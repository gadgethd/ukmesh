// $1: status networks; $2: packet networks. Both use the same public scope.
export const MQTT_NODES_SQL = `WITH raw_packet_counts AS MATERIALIZED (
  -- Resolve identities once per observer, not once per packet. The
  -- materialization fence keeps the function above the raw aggregate.
